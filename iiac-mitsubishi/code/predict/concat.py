...
base['T2_CASE0'] = base[['T2_CASE1', 'T2_CASE2', 'T2_CASE3', 'T2_CASE4']].apply(np.sum, axis=1)
base['T8_CASE0'] = base[['T8_CASE1', 'T8_CASE2']].apply(np.sum, axis=1)
base['T9_CASE0'] = base[['T9_CASE1', 'T9_CASE2', 'T9_CASE3', 'T9_CASE4']].apply(np.sum, axis=1)
base['ProcessingResultIsOK'] = True
base.loc[base['SignalFileName'] == 'Signal Package/20210421-part_8.pkl', 'ProcessingResultIsOK'] = False

base = base[list(ori_columns) + ['T2_CASE0', 'T2_CASE1', 'T2_CASE2', 'T2_CASE3', 'T2_CASE4', 'T8_CASE0', 'T8_CASE1', 'T8_CASE2', 'T9_CASE0', 'T9_CASE1', 'T9_CASE2', 'T9_CASE3', 'T9_CASE4', 'ProcessingResultIsOK']]
base[list(target_columns) + ['T2_CASE0', 'T8_CASE0', 'T9_CASE0']] = base[list(target_columns) + ['T2_CASE0', 'T8_CASE0', 'T9_CASE0']].astype(bool)
