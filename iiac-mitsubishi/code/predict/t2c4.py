...
def run_train2(base_dir, seed=315):
    ...
    x_test.loc[
        x_test["SignalFileName"] == "Signal Package/20210601-part_12.pkl", "T2_CASE4"
    ] = True  # 异常点
    x_test[["SignalFileName", "diff_min_cat", "T2_CASE4"]].to_csv(
        "../../data/result/t2c4_res.csv", index=False
    )
