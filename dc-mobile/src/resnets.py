...
def conv1x1(in_places, out_planes, stride=1):
    """1x1 convolution"""
    return nn.Conv1d(in_places, out_planes, kernel_size=1, stride=stride, bias=False)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=False) -> None:
        super().__init__()
...
class ResNet(nn.Module):
    def __init__(
        self, block, layers, in_channel=1, out_channel=8, zero_init_residual=False
    ) -> None:
        super().__init__()
        self.inplanes = 64
